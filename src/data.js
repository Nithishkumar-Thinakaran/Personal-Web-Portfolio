...
export const listProyek = [
  ...
  },
  {
    id: 1,
    image: Proyek1,
    title: "Multi-Step Loan Application",
    subtitle: "A web-based loan processing system designed to streamline the loan...",
    fullDescription:"A web-based loan processing system designed to streamline the loan application journey through multiple structured steps, including applicant information, document submission, eligibility verification, and loan review. The platform enhances accuracy, reduces processing time, and provides a seamless user experience by guiding applicants through each stage of the loan application process efficiently.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/Nithishkumar-Thinakaran/multi-step-loan-application",
    dad: "100",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    id: 5,
    image: Proyek5,
    title: "Artist Gallery System",
    subtitle: "A web-based platform designed to manage music collections...",
    fullDescription:"A web-based platform designed to manage music collections, artist profiles, movie information, and photo galleries through a centralized system. Developed as a modern alternative to the traditional method of accessing music through CDs, it enables users to search songs and explore detailed information about artists, movies, directors, and music composers through a user-friendly interface.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/Nithishkumar-Thinakaran/Artist-Gallery-Syetm",
    dad: "500",
  },
