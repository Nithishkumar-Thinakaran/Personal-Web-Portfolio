...
const experiences = [
  {
    ...
    description:
      "Built MERN-based web applications with API and payment gateway integration."
  },
  {
    ...
    description:
      "Developed Python-based web applications with database and backend integration."
  },
...
function App() {
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi, I'm Nithishkumar Thinkaran" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a 
                href="./assets/CV.pdf" 
                download="Nithishkumar_Thinakaran_CV.pdf" 
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m Nithishkumar Thinakaran, Computer Science postgraduate with strong experience in full-stack web development, Python programming, and database management. Skilled in MERN Stack, RESTful APIs, machine learning integration, and secure payment systems. Proven ability to deliver scalable, secure, and user-centric applications in agile environments."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-[60%]">
  <div>
  ...
  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
    <h1 className="text-3xl md:text-4xl mb-1">
      9.5<span className="text-violet-500">/10</span>
    </h1>
    <p>GPA</p>
  </div>
</div>
...
{/* Experience */}
<div className="mt-32" id="journey">
  ...
  <div className="relative max-w-6xl mx-auto">
    ...
    {/* Center Line */}
    <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-violet-500 -translate-x-1/2"></div>
    ...
    {experiences.map((exp, index) => (
      ...
      >
        ...
        {/* Connection Line */}
        <div
          className={`absolute top-1/2 h-1 bg-violet-500 w-20 ${
            index % 2 === 0
              ? "right-1/2"
              : "left-1/2"
          }`}
        ...
        {/* Timeline Dot */}
        <div className="absolute left-1/2 w-5 h-5 bg-violet-500 rounded-full -translate-x-1/2 z-20"></div>
        ...
        {/* Kontak */}
        <div className="kontak mt-20 sm:p-6 p-0 max-w-3xl mx-auto" id="contact">
          <h1
          ...
          >
            ...
            <div className="w-full">
              <form
                action="https://formsubmit.co/nithishkumarnk02@gmail.com"
                method="POST"
                className="bg-zinc-800 p-6 md:p-8 w-full rounded-md"
                autoComplete="off"
                data-aos="fade-up"
                data-aos-duration="1000"
                data-aos-delay="500"
